...
# ID ranges for scadashodan: 1081811 - 1136548
# for nonscadashodan: 1 - 37881
# for nonscadashodanmore: 37882 - 75765
# for sy_sfs_scadashodan: 299970 - 406926
...
FROM shodan.sy_scada_port_ngrams_new
ORDER BY count DESC
LIMIT 0, %d
""" % maxnum
cur.execute(sql)
...
sql = """
SELECT port, type, word, count
FROM shodan.sy_nonscada_port_ngrams_new
ORDER BY count DESC
LIMIT 0, %d
""" % maxnum
cur.execute(sql)
...
sql3 = """
INSERT INTO sy_testset_new (searchID, is_scada, port, length, num_grams,
